...
- **notes/** - Blog posts (title, description, publishDate, tags, draft, featured)
...
- `src/pages/notes/[...slug].astro` - Dynamic routes for individual notes

### Patterns

- Astro partial hydration - minimal client-side JS
- JSON-LD structured data on all pages (Person schema in layout, Article schema in notes)
